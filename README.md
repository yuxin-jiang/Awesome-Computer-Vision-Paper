...
- [1. Controllable Image Generation](#controllable-image-generation)[1.1 CutPaste Method Generation](#cutpaste-method-generation)

- [1.2 GAN Generation](#gan-generation)

- [1.3 Diffusion Generation](#diffusion-generation)[1.3.1 Text-based Generation](#text-based-generation)

- [1.3.2 Image-based Generation](#image-based-generation)

- [1.3.3 Multi-Modal Generation](#multi-modal-generation)[1.3.3.1 Text-Image Multi-Modal](#text-image-multi-modal)
...
- Multistage GAN for Fabric Defect Detection [[2019]](https://pubmed.ncbi.nlm.nih.gov/31870985/) [[code]](https://github.com/your-code-link-here) <!-- 若原无code链接，保留占位提示 -->
